<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Google.Standard.Admin.ascx.vb" Inherits="DotNetNuke.Modules.Map.Visuals.Google.StandardAdmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<TABLE class="Normal" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD align="center"><asp:panel id="pnlEditMarker" Runat="server" Visible="False">
							<TABLE width=540 class="Normal" cellSpacing="1" cellPadding="0" border="0">
								<TR>
