<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Google.Directory.Admin.ascx.vb" Inherits="DotNetNuke.Modules.Map.Visuals.Google.DirectoryAdmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<TABLE class="Normal" cellSpacing="0" cellPadding="0" width="540" border="0">
				...
				<TR>
					<TD align="center"><asp:panel id="pnlLicenseKeyEdit" Runat="server" Visible="False">
							<TABLE class="Normal" width=100% cellSpacing="1" cellPadding="0" border="0">
								<TR>
	...
	<tr>
		<td align=center>
			<TABLE class="Normal" cellSpacing="0" cellPadding="0" width="540" border="0">
				...
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDefaultRadius" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDefaultRadius" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryResultsPerPage" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryResultsPerPage" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectorySearchTemplate" Runat="server"></asp:label>
					</TD>
					<td align=right>
						<A href="javascript:Default('SEARCH','<%=txtDirectorySearchTemplate.ClientID %>');">
							<asp:Label id="lblDirectorySearchTemplateDefault" runat="server"></asp:Label></A>
					</TD>
				</TR>
				<TR>
					<TD colspan="2"><asp:textbox id="txtDirectorySearchTemplate" TextMode="MultiLine" Height="150px" Runat="server"
							Width="540px"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectorySeachNoResults" Runat="server"></asp:label>
					<td align=right>
						<A href="javascript:Default('EMPTY','<%=txtDirectorySeachNoResults.ClientID %>');">
							<asp:Label id="lblDirectorySeachNoResultsDefault" runat="server"></asp:Label></A>
					</TD>
				</TR>
				<TR>
					<TD colspan="2"><asp:textbox id="txtDirectorySeachNoResults" TextMode="MultiLine" Height="150px" Runat="server"
							Width="540px"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectorySearchTextboxID" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectorySearchTextboxID" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectorySearchButtonID" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectorySearchButtonID" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryElementID" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryElementID" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryCSS" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryCSS" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryCSSItem" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryCSSItem" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryCSSItemAlternate" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryCSSItemAlternate" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryCSSItemHover" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryCSSItemHover" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryPagingElementID" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryPagingElementID" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryPagingCSS" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryPagingCSS" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryPagingCSSLink" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryPagingCSSLink" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryPagingCSSHover" Runat="server"></asp:label></TD>
					<TD><asp:textbox id="txtDirectoryPagingCSSHover" Runat="server" Width="100"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryItemTemplate" Runat="server"></asp:label></TD>
					<td align=right>
					<A href="javascript:Default('ITEM','<%=txtDirectoryItemTemplate.ClientID %>');">
						<asp:Label id="lblDirectoryItemTemplateDefault" runat="server"></asp:Label></A>
					</td>						
				</TR>
				<TR>
					<TD colspan="2"><asp:textbox id="txtDirectoryItemTemplate" TextMode="MultiLine" Height="150px" Runat="server"
							Width="540px"></asp:textbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryOnclickPlot" Runat="server"></asp:label></TD>
					<TD><asp:checkbox id="chkDirectoryOnclickPlot" Runat="server" Width="100"></asp:checkbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryOnclickPan" Runat="server"></asp:label></TD>
					<TD><asp:checkbox id="chkDirectoryOnclickPan" Runat="server" Width="100"></asp:checkbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryOnclickZoom" Runat="server"></asp:label></TD>
					<TD>
						<asp:dropdownlist id="ddlDirectoryOnclickZoom" Runat="server" Width="100">
							<asp:ListItem Value="0">0</asp:ListItem>
							<asp:ListItem Value="1">1</asp:ListItem>
							<asp:ListItem Value="2">2</asp:ListItem>
							<asp:ListItem Value="3">3</asp:ListItem>
				...
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryOnclickClear" Runat="server"></asp:label></TD>
					<TD><asp:checkbox id="chkDirectoryOnclickClear" Runat="server" Width="100"></asp:checkbox></TD>
				</TR>
				<TR>
					<TD class="SubHead" style="WIDTH: 165px" noWrap><asp:label id="lblDirectoryUseDistanceCalculation" Runat="server"></asp:label></TD>
					<TD><asp:checkbox id="chkDirectoryUseDistanceCalculation" Runat="server" Width="100"></asp:checkbox></TD>
				</TR>
			</TABLE>
		</td>
	</tr>
