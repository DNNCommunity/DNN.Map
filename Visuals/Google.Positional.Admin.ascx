<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Google.Positional.Admin.ascx.vb" Inherits="DotNetNuke.Modules.Map.Visuals.Google.PositionalAdmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
